<x-app-layout>
                ...
                @if($streak == 1 && $marcouHoje)
                    <div x-data="{ 
                        ...
                        <div class="relative z-10 flex flex-col items-center justify-center scale-150">
                            <div class="absolute w-full h-full bg-orange-500/40 rounded-full blur-[80px] animate-pulse">
                            </div>
                            <div class="relative drop-shadow-[0_0_50px_rgba(255,100,0,1)]">
                                <svg class="w-40 h-40 text-orange-500 animate-bounce" style="animation-duration: 0.8s;"
                            ...
                            <div class="mt-4 text-center">
                                <h2
                                    class="text-3xl font-black text-white italic tracking-tighter drop-shadow-xl uppercase animate-pulse">
                                    Chama Acesa!</h2>
                            </div>
                        </div>
                    </div>
                ...
                @foreach($medalhasHoje as $index => $badge)
                    <div x-data="{ 
                        ...
                        <div class="relative z-10 flex flex-col items-center justify-center scale-150 p-6 rounded-3xl">
                            ...
                            <div class="absolute w-full h-full bg-yellow-500/30 rounded-full blur-[60px] animate-pulse">
                            </div>

                            {{-- Ícone da Medalha --}}
                            <div class="relative text-6xl mb-4 drop-shadow-[0_0_30px_rgba(234,179,8,0.8)] animate-bounce"
                                style="animation-duration: 1s;">
                                {{ $badge->icon }}
                            </div>

                            <div class="relative z-10 text-center">
                                <p class="text-[10px] font-bold text-yellow-400 uppercase tracking-widest mb-1">Nova
                                    Conquista!</p>
                            ...
                            <div class="absolute top-10 -right-12 w-2 h-2 bg-red-400 -rotate-12 animate-ping"
                                style="animation-delay: 0.2s"></div>
                            <div class="absolute -bottom-5 left-10 w-2 h-2 bg-green-400 rotate-45 animate-ping"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
                ...
                <div id="tour-chamada"
                    ...
                    <div class="relative z-10 flex flex-col gap-6">
                        ...
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <div
                                    class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 backdrop-blur-md text-xs font-semibold mb-2 border border-white/10 shadow-sm">
                                    ...
                                    {{ date('d/m') }} <span class="opacity-60">|</span>
                                    {{ \Carbon\Carbon::now()->locale('pt_BR')->dayName }}
                                </div>
                                <h2 class="text-2xl sm:text-3xl font-bold leading-tight tracking-tight">Diário de Classe
                                </h2>
                            </div>
                            <div
                                class="bg-white/20 p-2.5 rounded-2xl backdrop-blur-md border border-white/10 shadow-lg hidden sm:block">
                        ...
                        <div class="space-y-3">
                            ...
                            <button @click="abrirModal()"
                                ...
                                <div class="flex flex-col items-start">
                                    @if($temAulaHoje)
                                        ...
                                        <span
                                            class="text-xs font-medium text-indigo-500/80 mt-1 uppercase tracking-wide">Aulas
                                            de Hoje</span>
                                    @else
                                        <span class="text-lg leading-none">Gerenciar Frequência</span>
                                        <span
                                            class="text-xs font-medium text-indigo-500/80 mt-1 uppercase tracking-wide">Histórico
                                            & Ajustes</span>
                                    @endif
                                </div>
                                <div
                                    class="bg-indigo-100/50 p-2 rounded-xl group-hover:bg-indigo-100 transition-colors">
                            ...
                            {{-- MOBILE ONLY: Consultar Oráculo --}}
                            <button @click="$dispatch('open-ai-sidebar')"
                                class="md:hidden relative overflow-hidden w-full bg-indigo-600 hover:bg-indigo-700 border border-white/20 text-white font-bold py-4 px-6 rounded-2xl shadow-lg transition active:scale-[0.98] flex items-center justify-between group">
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity">
                                </div>
                                <div class="flex items-center gap-3 relative z-10">
                                    <span class="text-2xl">✨</span>
                                    <div class="flex flex-col items-start leading-none">
                                        <span class="text-lg">Consultar Oráculo</span>
                                    </div>
                                </div>
                                <svg class="w-6 h-6 text-indigo-200 relative z-10" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5l7 7-7 7"></path>
                                </svg>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                {{-- MARCAR FOLGA --}}
                                <button @click="modalEvento = true"
                                    class="w-full bg-white/10 hover:bg-white/20 border border-white/10 text-white font-medium py-3.5 px-4 rounded-xl transition active:scale-[0.98] flex items-center justify-center gap-2 backdrop-blur-sm">
                                ...
                                {{-- GERENCIAR DIAS SEM AULA (Link convertido em Botão) --}}
                                <a href="{{ route('eventos.index') }}"
                                    class="w-full bg-white/10 hover:bg-white/20 border border-white/10 text-white font-medium py-3.5 px-4 rounded-xl transition active:scale-[0.98] flex items-center justify-center gap-2 backdrop-blur-sm text-center">
                                    <svg class="w-5 h-5 text-white/80" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <span class="text-sm">Gerenciar Dias</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-show="modalOpen" style="display: none;" @keydown.escape.window="modalOpen = false"
                        ...
                        <div
                            class="relative w-full max-w-md rounded-3xl bg-white dark:bg-[#0B1220] shadow-2xl shadow-black/20 dark:shadow-black/60 border border-gray-100 dark:border-white/10 overflow-hidden flex flex-col max-h-[90vh]">
                            <div
                                ...
                                <button @click="modalOpen = false"
                                    class="p-2 -mr-2 text-gray-400 hover:text-gray-600 transition"><svg class="w-6 h-6"
                            ...
                            <div class="flex-1 overflow-y-auto p-6 space-y-6">
                                <div>
                                    <label class="block text-xs font-bold text-gray-500 uppercase mb-2">Selecione a
                                        Data</label>
                                    <input type="date" x-model="dataSelecionada" @change="validarDataEBuscar()"
                                ...
                                <div class="min-h-[200px]">
                                    <div x-show="loading"
                                        ...
                                        <svg class="animate-spin h-8 w-8 text-blue-500 mb-3" fill="none"
                                            viewBox="0 0 24 24">
                                    ...
                                    <div x-show="sucesso"
                                        class="flex flex-col items-center justify-center h-40 text-emerald-500">
                                        <div
                                    ...
                                    <div x-show="!loading && !sucesso">
                                        <div x-show="aulas.length === 0 && !loading"
                                        ...
                                        <div class="space-y-3">
                                            <template x-for="(aula, index) in aulas" :key="index">
                                                <div
                                                    class="flex items-center justify-between p-4 rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
                                                    <div>
                                                        <div class="flex items-center gap-2">
                                                            <h4 class="font-bold text-gray-800 dark:text-gray-100"
                                                                x-text="aula.nome"></h4>
                                                            <span x-show="aula.ja_registrado"
                                                                class="text-[10px] bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full font-bold uppercase tracking-wider">Editando</span>
                                                        </div>
                                                    ...
                                                    <button @click="aula.presente = !aula.presente"
                                                        class="w-12 h-12 rounded-xl flex items-center justify-center transition-all active:scale-90 shadow-sm border"
                                                        :class="aula.presente ? 'bg-emerald-50 border-emerald-200 text-emerald-600' : 'bg-red-50 border-red-200 text-red-600'">
                                                        <span class="font-bold text-lg"
                                                            x-text="aula.presente ? 'P' : 'F'"></span>
                                                    </button>
                                                </div>
                                            </template>
                                        </div>
                            ...
                            <div
                                class="p-6 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-black/20">
                                <button x-show="aulas.length > 0 && !loading && !sucesso" @click="confirmarChamada()"
                                    :disabled="enviando"
                                    class="w-full bg-blue-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-500/30 active:scale-[0.98] transition-all disabled:opacity-50"><span
                                        x-show="!enviando">Confirmar Chamada</span><span
                                        x-show="enviando">Salvando...</span></button>
                                <button x-show="aulas.length === 0 || sucesso" @click="modalOpen = false"
                                    class="w-full bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/10 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-bold py-4 rounded-xl shadow-sm">Fechar</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-show="modalEvento" style="display: none" @keydown.escape.window="modalEvento = false"
                        ...
                        <div
                            class="relative w-full max-w-md rounded-3xl p-6 bg-white dark:bg-[#0B1220] border border-gray-100 dark:border-white/10 shadow-2xl shadow-black/20 dark:shadow-black/60">
                            ...
                            <form method="POST" action="{{ route('eventos.store') }}" class="space-y-4">
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Título</label>
                                    <input type="text" name="titulo" required
                                        placeholder="Ex: Feriado, Recesso, Falta Justificada"
                                        class="w-full rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0F172A] text-gray-900 dark:text-white py-3 px-4 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm">
                                </div>
                                <div>
                                    <label
                                        class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Data</label>
                                    <input type="date" name="data" required
                                        class="w-full rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0F172A] text-gray-900 dark:text-white py-3 px-4 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm">
                                </div>
                                <div>
                                    <label
                                        class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Tipo</label>
                                ...
                                <div class="flex gap-3 pt-2">
                                    <button type="submit"
                                        class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl shadow-lg shadow-blue-600/30 active:scale-[0.98] transition">Salvar</button>
                                    <button type="button" @click="modalEvento = false"
                                        class="flex-1 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-700 dark:text-gray-300 font-bold py-3 rounded-xl hover:bg-gray-50 dark:hover:bg-white/10 transition">Cancelar</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div id="tour-status" class="grid grid-cols-1 gap-4 lg:gap-6">
                    ...
                    <div id="dashboard-stats" class="contents">
                        ...
                        <div
                            class="bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-[2rem] border border-white/20 dark:border-gray-800 p-6 flex flex-col justify-center shadow-sm">
                            <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Presença total
                                acumulada</p>
                            ...
                            @if($estadoVazio)
                                ...
                                <div class="flex items-center gap-3 opacity-60">
                                    ...
                                    <span class="text-xs font-medium text-gray-400 leading-tight">Aguardando<br>primeiros
                                        dados</span>
                                </div>
                            @else
                        ...
                        <div
                            class="bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-[2rem] border border-white/20 dark:border-gray-800 p-6 flex flex-col justify-center shadow-sm">
                            <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Matérias Em Risco
                            </p>
                            ...
                            @if($estadoVazio)
                                ...
                                <div class="flex items-center gap-3 opacity-60">
                                    <div
                                        class="w-10 h-10 rounded-xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-300 dark:text-gray-600">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M20 12H4"></path>
                                        </svg>
                                    </div>
                                    <span class="text-xs font-medium text-gray-400 leading-tight">Sem
                                        dados<br>suficientes</span>
                                </div>
                            @elseif($materiasEmRisco > 0)
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span
                                        class="px-2 py-1 rounded-md bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 text-xs font-bold uppercase">Matérias</span>
                                </div>
    ...
    : 'bg-white text-gray-600 border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700' }}">
                    ...
                    @if(request('filtro') == 'hoje')
                        <div
                            class="mb-4 flex items-center gap-2 text-sm text-blue-600 dark:text-blue-400 font-bold bg-blue-50 dark:bg-blue-900/20 px-3 py-2 rounded-lg inline-flex">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            Mostrando apenas aulas {{ now()->isWeekend() ? 'deste' : 'desta' }} {{ now()->translatedFormat('l') }}
                            </div>
                    @elseif(request('filtro') == 'risco')
                        <div
                            class="mb-4 flex items-center gap-2 text-sm text-red-600 dark:text-red-400 font-bold bg-red-50 dark:bg-red-900/20 px-3 py-2 rounded-lg inline-flex">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                            ...
                            @if($disciplinasFiltradas->isNotEmpty())
                                <a href="{{ route('disciplinas.criar') }}" id="tour-nova-materia"
                                    ...
                                    <div
                                        class="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-sm">
                                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <h4
                                        ...
                                        Nova Matéria</h4>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 text-center mt-1">Adicionar à grade
                                    </p>
                                </a>
                            @endif
                            ...
                            @forelse($disciplinasFiltradas as $disciplina)
                                ...
                                <div
                                    class="group bg-white/70 dark:bg-gray-900/70 backdrop-blur-md rounded-3xl border border-white/20 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden flex flex-col justify-between">
                                    <div class="h-2 w-full absolute top-0 left-0"
                                        style="background-color: {{ $disciplina->cor ?? '#3B82F6' }}"></div>

                                    <div class="p-6">
                                        <div class="flex justify-between items-start mb-6">
                                            <h4
                                                class="text-lg font-bold text-gray-900 dark:text-white truncate pr-4 leading-tight">
                                                {{ $disciplina->nome }}
                                            </h4>
                                            ...
                                            <div class="flex flex-col items-end">
                                                ...
                                                <span
                                                    class="text-3xl font-extrabold text-gray-900 dark:text-white leading-none tracking-tighter">
                                                    {{ $totalFaltas }}

                                                    {{-- Mostra o Limite (ex: "/ 20") se houver previsão --}}
                                                    @if($totalPrevisto > 0)
                                                        <span class="text-sm text-gray-400 font-normal"
                                                            title="Limite de faltas (25% de {{ $totalPrevisto }} aulas)">
                                                            /{{ $limiteFaltas }}
                                                        </span>
                                                    @endif
                                                </span>
                                                ...
                                                @if($totalPrevisto > 0)
                                                    ...
                                                    <span
                                                        class="text-[10px] font-bold {{ $restantes < 3 ? 'text-red-500 animate-pulse' : 'text-gray-400' }} uppercase tracking-wide">
                                                        {{ $restantes >= 0 ? 'Faltas restantes: ' . $restantes : 'Reprovado' }}
                                                    </span>
                                                @else
                                                    {{-- Fallback: Se não tiver datas cadastradas, mostra só "Faltas" --}}
                                                    <span
                                                        class="text-[10px] font-bold text-gray-400 uppercase tracking-wide">Faltas</span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-y-2">
                                            <div class="flex justify-between items-end">
                                                ...
                                                <span
                                                    class="text-sm font-bold {{ $corTexto }}">{{ $textoPorcentagem }}%</span>
                                            </div>
                                    ...
                                    <div
                                        class="px-6 py-4 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-black/20 flex justify-between items-center">
                                        <a href="{{ route('grade.index', $disciplina->id) }}"
                                            class="text-xs font-bold text-blue-600 hover:text-blue-700 transition flex items-center gap-1 bg-blue-50 dark:bg-blue-900/20 px-3 py-1.5 rounded-lg">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <a href="{{ route('disciplinas.edit', $disciplina->id) }}"
                                                class="p-2 text-gray-400 hover:text-blue-500 hover:bg-white dark:hover:bg-gray-800 rounded-lg transition"
                                            ...
                                            <button type="button" onclick="deleteDisciplina({{ $disciplina->id }})"
                                                class="p-2 text-gray-400 hover:text-red-500 hover:bg-white dark:hover:bg-gray-800 rounded-lg transition"
                            ...
                            @empty
                                <div
                                    class="col-span-full flex flex-col items-center justify-center py-12 px-4 text-center animate-fade-in-up">
                                    ...
                                    @if(request('filtro') == 'hoje')
                                        ...
                                        <div class="relative mb-6">
                                            ...
                                            <div
                                                class="relative w-24 h-24 bg-orange-50 dark:bg-orange-900/20 rounded-full flex items-center justify-center border border-orange-100 dark:border-orange-800">
                                    ...
                                    @elseif(request('filtro') == 'risco')
                                        ...
                                        <div class="relative mb-6">
                                            ...
                                            <div
                                                class="relative w-24 h-24 bg-emerald-50 dark:bg-emerald-900/20 rounded-full flex items-center justify-center border border-emerald-100 dark:border-emerald-800">
                                    ...
                                    @else
                                        ...
                                        <div class="md:hidden flex flex-col items-center">
                                            <div class="relative mb-6 group">
                                                ...
                                                <div
                                                    class="relative w-24 h-24 bg-blue-50 dark:bg-blue-900/20 rounded-full flex items-center justify-center border border-blue-100 dark:border-blue-800">
                                                    <svg class="w-10 h-10 text-blue-500 dark:text-blue-400" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                            ...
                                            <p
                                                class="text-gray-500 dark:text-gray-400 max-w-xs mx-auto mb-12 text-sm leading-relaxed">
                                        ...
                                        <div class="hidden md:flex flex-col items-center max-w-2xl mx-auto">
                                            ...
                                            <div class="relative mb-10 group cursor-default">
                                                ...
                                                <div
                                                    class="relative w-32 h-32 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center border-4 border-blue-50 dark:border-blue-900/30 shadow-2xl">
                                                    <svg class="w-14 h-14 text-blue-600 dark:text-blue-400 ml-1" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                            ...
                                            <p class="text-lg text-gray-500 dark:text-gray-400 mb-10 leading-relaxed max-w-lg">
                                                Para o Frequência Certa funcionar, precisamos saber quais matérias você cursa.
                                                Cadastre sua grade horária e deixe o resto com a gente.
                                            </p>

                                            {{-- Botão de Ação Principal (CTA) --}}
                                            <a href="{{ route('disciplinas.criar') }}" id="tour-nova-materia"
                                                class="group relative inline-flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white text-lg font-bold py-4 px-10 rounded-2xl shadow-xl shadow-blue-600/20 active:scale-[0.98] transition-all duration-200 transform hover:-translate-y-1">
                                                ...
                                                <div
                                                    class="absolute inset-0 rounded-2xl ring-2 ring-white/20 group-hover:ring-white/40 transition-all">
                                                </div>
                                            </a>
                                        </div>
                        ...
                        <button id="tour-oracle" onclick="window.dispatchEvent(new CustomEvent('open-ai-sidebar'))"
                            ...
                            <span class="font-bold text-sm max-w-0 overflow-hidden opacity-0
