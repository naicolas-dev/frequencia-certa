...
<body
  ...
  x-data="registerPage()" x-init="init()">
  ...
  <main class="relative z-10 w-full max-w-[420px] px-4 py-10">
    <div
      ...
      <div class="text-center mb-8">
        <div
          class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-tr from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-500/30 mb-5 transform rotate-6 hover:rotate-0 transition-transform duration-300">
      ...
      <form method="POST" action="{{ route('register') }}" class="space-y-5" @submit="onSubmit($event)">
        ...
        <div>
          <label for="name" class="block text-sm font-bold text-gray-800 dark:text-gray-200 mb-2 ml-1">Nome
            Completo</label>
          <input id="name"
        ...
        <div>
          ...
          <div class="relative">
            <input id="password" x-model="password" x-bind:type="showPassword ? 'text' : 'password'" minlength="8"
          ...
          <div x-cloak x-show="password.length > 0" x-transition
            class="h-1 w-full bg-gray-200 dark:bg-gray-700 rounded-full mt-2 overflow-hidden" role="progressbar"
            aria-label="Força da senha" :aria-valuenow="strengthScore" aria-valuemin="0" aria-valuemax="4"
        ...
        <div>
          <label for="password_confirmation"
            class="block text-sm font-bold text-gray-800 dark:text-gray-200 mb-2 ml-1">Confirmar Senha</label>
          <input id="password_confirmation" x-model="passwordConfirmation"
          ...
          <p id="password-confirm-help" class="mt-2 text-sm font-medium text-red-600 dark:text-red-400 ml-1" x-cloak
