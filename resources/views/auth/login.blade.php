  ...
  >
    ...
    >
      ...
      >
        <div class="flex items-start justify-between gap-3">
          ...
          <button
            type="button"
            class="text-xs font-bold opacity-70 hover:opacity-100"
    ...
    <div class="absolute top-6 right-6 z-50">
      ...
      >
        ...
        <svg
          class="w-6 h-6 block dark:hidden text-gray-600"
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path
      ...
      >
        ...
        >
          ...
          <div>
            <label
              for="email"
              class="block text-sm font-bold text-gray-800 dark:text-gray-200 mb-2 ml-1"
              >Email</label
            >
            <input
              id="email"
          ...
          <div class="flex items-center justify-between mt-4">
            <label
              for="remember_me"
              class="flex items-center cursor-pointer group select-none py-2 -my-2 pr-2"
            >
              <input
                id="remember_me"
                type="checkbox"
              ...
              />
              <span
                class="ms-2 text-sm font-medium text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors"
                >Lembrar de mim</span
              >
            </label>
            ...
            <a
              class="text-sm font-bold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition underline underline-offset-4 decoration-blue-300/50 p-2 -mr-2"
      ...
      function loginPage() {
        ...
        return {
          ...
          async handleSocial(provider) {
            ...
            // ✅ quando o popup fecha, o foco volta -> destrava rápido
